...
\scriptsize
Quando a bolha imobiliária finalmente estourou, a queda de um dos pilares do sistema bancário americano serviu como gatilho para um colapso global. Como inúmeros títulos de dívida estavam vinculados a essa instituição, o sistema financeiro desmoronou rapidamente, provocando uma derrocada nas bolsas e instalando o caos generalizado em Wall Street.
\end{alertblock}
\column{0.32\textwidth}
